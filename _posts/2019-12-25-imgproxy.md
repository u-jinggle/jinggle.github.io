...
github에서는 다양한 설치 방법을 제시하고 있지만 저는 AWS에 ec2에 Docker를 통해 설치해 보도록 하겠습니다. 
 
## ec2 생성
ec2는 다른 부가 기능 없이 docker를 띄워 imageproxy 기능만 수행할 것이기 때문에 제일 기본적인 옵션으로 생성해 주도록 하겠습니다.  
### 단계 1: Amazon Machine Image(AMI) 선택
뒤에서 docker를 설치할 것이기 떄문에 가장 기본적인 AMI를 선택해 주도록 하겠습니다.  
...
#### 실행
{% highlight Bash %}
docker run -p 80:8080 willnorris/imageproxy
{% endhighlight %}
#### 결과
![docker imgproxy 실행 예시이미지](/assets/images/2019-12-25_4.png){: width="100%"}  
...
resize외에도 [imgproxy github](https://github.com/willnorris/imageproxy)에서는 다양한 옵션을 제공하고 있습니다.    
